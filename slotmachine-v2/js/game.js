...
function drawSlotMachine() {
    ...
    Bet1Button.addEventListener("mouseover", function (event) {
        Bet1Button.alpha = 0.5;
    });
    Bet1Button.addEventListener("mouseout", function (event) {
    ...
    Bet2Button.addEventListener("mouseover", function (event) {
        Bet2Button.alpha = 0.5;
    });
    Bet2Button.addEventListener("mouseout", function (event) {
    ...
    Bet5Button.addEventListener("mouseover", function (event) {
        Bet5Button.alpha = 0.5;
    });
    Bet5Button.addEventListener("mouseout", function (event) {
    ...
    Bet100Button.addEventListener("mouseover", function (event) {
        Bet100Button.alpha = 0.5;
    });
    Bet100Button.addEventListener("mouseout", function (event) {
    ...
    Bet500Button.addEventListener("mouseover", function (event) {
        Bet500Button.alpha = 0.5;
    });
    Bet500Button.addEventListener("mouseout", function (event) {
...
function Reels() {
    ...
    for (var spin = 0; spin < 3; spin++) {
        ...
        switch (outCome[spin]) {
            case checkRange(outCome[spin], 1, 23):
                betLine[spin] = "blank";
                blanks++;
                break;
            case checkRange(outCome[spin], 24, 27):
                betLine[spin] = "apple";
                apples++;
                break;
...
function onResize() {
    ...
    // stage dimensions
    var originalWidth = 677;
    var originalHeight = 486;
